...
const TaskScreen = () => {
    ...
    <View style={styles.container}>
      ...
      <View style={styles.statusContainer}>
        <View style={styles.statusTextWrapper}>
          <Text style={styles.statusText}>Встреча в процессе</Text>
          <Text style={styles.statusAddress}>ул. Зиповская 3/4, 1 к. 192</Text>
        </View>
        <View style={styles.statusIconWrapper}>
          <MaterialCommunityIcons name="pen" size={24} color="white" style={styles.statusIcon} />
        </View>
      </View>      
  ...
  onPress={() => navigation.navigate('Doroga4')} 
>
        <Text style={styles.actionButtonText}>завершить встречу </Text>
      </TouchableOpacity>
